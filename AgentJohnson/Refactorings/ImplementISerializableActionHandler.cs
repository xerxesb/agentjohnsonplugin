...
namespace AgentJohnson.Refactorings {
  ...
  public class ImplementISerializableActionHandler : ActionHandlerBase {
    ...
    static void AddAttribute(ISolution solution, IClassDeclaration classDeclaration, CSharpElementFactory factory) {
    ...
    /// <param name="classDeclaration">The class declaration.</param>
    /// <param name="factory">The factory.</param>
    static void AddConstructor(IClassDeclaration classDeclaration, CSharpElementFactory factory) {
      ...
      AddMember(classDeclaration, factory, @"
        protected Constructor([NotNull] SerializationInfo info, StreamingContext context) {" +
                                           code + @"
        }
      ");
    }
    ...
    /// <returns></returns>
    static string AddConstructorCode(IClass cls, bool isSuperClass) {
    ...
    /// <param name="classDeclaration">The class declaration.</param>
    /// <param name="factory">The factory.</param>
    static void AddGetObjectDataMethod(IClassDeclaration classDeclaration, CSharpElementFactory factory) {
      IClass cls = classDeclaration.DeclaredElement as IClass;
      if(cls == null) {
        return;
      }
    ...
    /// <param name="isSuperClass">if set to <c>true</c> [is super class].</param>
    /// <returns></returns>
    static string AddGetObjectDataMethodCode(IClass classDeclaration, bool isSuperClass) {
      string code = string.Empty;
