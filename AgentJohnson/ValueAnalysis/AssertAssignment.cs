...
namespace AgentJohnson.ValueAnalysis {
  ...
  /// </summary>
  [ContextAction(Description = "Assert an assignment.", Name = "Assert Assignment", Priority = 0, Group = "C#")]
  public class AssertAssignment : OneItemContextActionBase {
    #region Fields
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AssertAssignment"/> class.
    /// </summary>
    /// <param name="solution">The solution.</param>
    /// <param name="textControl">The text control.</param>
    public AssertAssignment(ISolution solution, ITextControl textControl) : base(solution, textControl) {
      _solution = solution;
